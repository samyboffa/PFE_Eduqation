...
class Page500 extends Component {
  ...
  return (
    <div>
                        ...
                        <div className="tab-content">
                            ...
                            <form role="form" className="form-horizontal">
                                ...
                                <div className="col-sm-12">
                                    <input className="form-control" id="email1" placeholder="Matricule" type="text"
                ...
                <header className="top-navbar" style={{background:"#042e60"}}>
                    <nav className="navbar navbar-expand-lg navbar-light " style={{background:"#042e60"}}>
                    <div className="container-fluid" style={{background:"#042e60"}}>
                        <a className="navbar-brand" href="index.html" style={{background:"#042e60"}}>
                        ...
                        <span className="icon-bar" style={{background:"#042e60"}}/>
                        <span className="icon-bar" />
                        <span className="icon-bar" />
                        </button>
                        <div className="collapse navbar-collapse" id="navbars-host" style={{background:"#042e60"}}>
                        ...
                        <ul className="nav navbar-nav navbar-right">
                            <li><a className="hover-btn-new log orange" href="#" data-toggle="modal" data-target="#login"><span>Login Now</span></a></li>
                        </ul>
                        </div>
                    </div>
                    </nav>
                ...
                <div id="carouselExampleControls" className="carousel slide bs-slider box-slider" data-ride="carousel" data-pause="hover" data-interval="false" >
                    ...
                    <div className="carousel-item active">
                        <div id="home" className="first-section" style={{backgroundImage: 'url("homeassets/images/slider-01.jpg")'}}>
                        <div className="dtab">
                            <div className="container">
                            <div className="row">
                                <div className="col-md-12 col-sm-12 text-right">
                                <div className="big-tagline">
                                    <h2><strong>My_Scoloarity </strong> education universitaire</h2>
                                    <p className="lead">bienvenue à notre siteWeb</p>
                    ...
                    <div className="carousel-item">
                        <div id="home" className="first-section" style={{backgroundImage: 'url("homeassets/images/slider-02.jpg")'}}>
                        <div className="dtab">
                            <div className="container">
                            <div className="row">
                    ...
                    <div className="carousel-item">
                        <div id="home" className="first-section" style={{backgroundImage: 'url("homeassets/images/slider-03.jpg")'}}>
                        <div className="dtab">
                            <div className="container">
                            <div className="row">
                ...
                <div id="overviews" className="section wb">
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="post-media wow fadeIn">
                            <img src="homeassets/images/about_02.jpg" alt className="img-fluid img-rounded" />
                        </div>{/* end media */}
                        </div>{/* end col */}
                    </div>
                    <div className="row align-items-center">
                ...
                <div id="testimonials" className="parallax section db parallax-off" style={{backgroundImage: 'url("homeassets/images/parallax_04.jpg")'}}>
                    <div className="container">
                    <div className="section-title text-center">
                        <h3>Testimonials</h3>
                        <p>Lorem ipsum dolor sit aet, consectetur adipisicing lit sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                    ...
                    <div className="row">
                        ...
                        <div className="testi-carousel owl-carousel owl-theme">
                            ...
                            <div className="testi-meta">
                                <img src="homeassets/images/testi_01.png" alt className="img-fluid" />
                            ...
                            <div className="testimonial clearfix">
                            <div className="testi-meta">
                                <img src="homeassets/images/testi_02.png" alt className="img-fluid" />
                            ...
                            <div className="testimonial clearfix">
                            <div className="testi-meta">
                                <img src="homeassets/images/testi_03.png" alt className="img-fluid " />
                                <h4>Venanda Mercy </h4>
                            </div>
                            <div className="desc">
                ...
                <div className="parallax section dbcolor">
                    ...
                    <div className="row logos">
                        ...
                        <a href="#"><img src="homeassets/images/logo_01.png" alt className="img-repsonsive" /></a>
                        </div>
                        <div className="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                        <a href="#"><img src="homeassets/images/logo_02.png" alt className="img-repsonsive" /></a>
                        </div>
                        <div className="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                        <a href="#"><img src="homeassets/images/logo_03.png" alt className="img-repsonsive" /></a>
                        </div>
                        <div className="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                        <a href="#"><img src="homeassets/images/logo_04.png" alt className="img-repsonsive" /></a>
                        </div>
                        <div className="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                        <a href="#"><img src="homeassets/images/logo_05.png" alt className="img-repsonsive" /></a>
                        </div>
                        <div className="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                        <a href="#"><img src="homeassets/images/logo_06.png" alt className="img-repsonsive" /></a>
                        </div>
                    </div>{/* end row */}
                    </div>{/* end container */}
                </div>{/* end section */}
